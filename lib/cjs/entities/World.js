...
class Cell {
    ...
    touchPheromones(currentTick) {
        ...
        this.foodPheremone = this.foodPheremone - (this.foodPheremone * (0, antConfig_1.antConfig)().foodPheremoneDecay * evaporationTime);
        this.homePheremone = this.homePheremone - (this.homePheremone * (0, antConfig_1.antConfig)().homePheremoneDecay * evaporationTime);
    }
    addPheremone(stepsFromHome, stepsFromFood, currentTick) {
        this.touchPheromones(currentTick);
        if (!!stepsFromFood) {
            this.foodPheremone = this.foodPheremone + ((0, antConfig_1.antConfig)().foodDistanceFactor / stepsFromFood);
        }
        this.homePheremone = this.homePheremone + ((0, antConfig_1.antConfig)().homeDistanceFactor / stepsFromHome);
    }
}
exports.Cell = Cell;
class AntWorld {

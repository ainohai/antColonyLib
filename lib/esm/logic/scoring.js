...
export const scoreDirections = (ant, world, tick, scoreFunction) => {
    ...
    nextAngles.forEach((angle, index) => {
        let score = getScoreForDirection(angle, ant, world, tick, scoreFunction);
        scores.push(score);
    });
    return scores;
};
export const getScoreForDirection = (angle, ant, world, currentTick, scoreFunction) => {
...
export const getRandomDirectionScored = (ant, world, currentTick, scoreFunction) => {
